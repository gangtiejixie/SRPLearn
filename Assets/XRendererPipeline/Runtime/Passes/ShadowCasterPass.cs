...
namespace SRPLearn
{
    ...
    public class ShadowCasterPass
    {
        ...
        private Matrix4x4 _worldToCascadeShadowMapMatrices = new Matrix4x4();
        ...
        public class ShadowMapTextureHandler
        {
            ...
            private RenderTargetIdentifier _renderTargetMaskIdentifier = "_XMainShadowMapMask";
            private int _shadowmapId = Shader.PropertyToID("_XMainShadowMap");
            private RenderTexture _shadowmapTexture;
            private RenderTexture _shadowmapMaskTexture;
            ...
            public RenderTargetIdentifier renderTargetMaskIdentifier
            {
                get
                {
                    return _renderTargetMaskIdentifier;
                }
            }
            ...
            public void AcquireRenderTextureIfNot(int resolution)
            {
                if (_shadowmapTexture && _shadowmapTexture.width != resolution)
                {
                    ...
                    RenderTexture.ReleaseTemporary(_shadowmapMaskTexture);

                    _shadowmapMaskTexture = null;
                ...
                if (!_shadowmapTexture)
                {
                    ...
                    _renderTargetMaskIdentifier = new RenderTargetIdentifier(_shadowmapMaskTexture);
                }
            }
